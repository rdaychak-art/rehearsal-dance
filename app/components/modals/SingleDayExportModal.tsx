...
interface SingleDayExportModalProps {
  isOpen: boolean;
  onClose: () => void;
  onExport: (from: string, to: string) => void;
}

export const SingleDayExportModal: React.FC<SingleDayExportModalProps> = ({ isOpen, onClose, onExport }) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md overflow-hidden">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900">Download Schedule</h2>
